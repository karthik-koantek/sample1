...
def hydrate(project_name):
  ...
  #teardown
  onb.hydrate_generic_notebook(project_name=project_name,system_name='UAT_SQL_Teardown',stage_name='UAT_SQL_Teardown_daily',job_name='UAT_SQL_Teardown',system_secret_scope='internal',parameters = {},notebook_path = '../Data Quality Rules Engine/UAT_SQL_Teardown',system_is_active = True,stage_is_active = True,job_is_active = True,system_order = 10,stage_order = 10,job_order = 10)
