...
e = ktk.aiml.LinearRegressionExperiment(snb, snb.experimentName)
e.displayAttributes()
...
if snb.label == "":
  ...
  err = {
    "sourceName": "Linear Regression: Validation",
    "errorCode": "100",
    "errorDescription": errorDescription
  }
  error = json.dumps(err)
...
try:
  ...
  run_uuid, predictio = e.trainingRun(dfList[-1], runName)
  print("Run UUID: {0}".format(run_uuid))
except Exception as e:
  err = {
    "sourceName": "Train Linear Regression: Train",
    "errorCode": "200",
