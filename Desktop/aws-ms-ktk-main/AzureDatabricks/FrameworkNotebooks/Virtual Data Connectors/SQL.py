...
# MAGIC %md
# MAGIC Hardcode the parameters used to connect to the data source.  Later on we will convert these to secrets.

# COMMAND ----------

#Hard code the parameters used to connect to the data source
serverName = "ktkvdc.database.windows.net"
port = 1433
databaseName = "ktkvdc"
...
columnsDF = runQuery(jdbcUrl, columns, login, pwd, driver)
proceduresDF = runQuery(jdbcUrl, procedures, login, pwd, driver)
