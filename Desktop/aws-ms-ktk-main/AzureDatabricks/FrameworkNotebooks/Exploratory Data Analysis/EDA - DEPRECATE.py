...
# MAGIC %md # EDA
# MAGIC
# MAGIC Generates summary statistics for every colum in the supplied table.  Writes data to Summary Zone and to a table with EDA_TableName naming convention.
# MAGIC
# MAGIC #### Usage
# MAGIC
# MAGIC #### Prerequisites
...
summaryPath = "{0}/summary/EDA/{1}".format(adlbasepath, tableName)
vcSummaryPath = "{0}/summary/EDA/{1}_TopValueCounts".format(adlbasepath, tableName)
