...
# MAGIC %md # Data Profiling - DataPrep Bivariate
...
try:
  ...
  err = {
    "sourceName": "Data Profiling - DataPrep: Bivariate Object",
    "errorCode": "400",
    "errorDescription": e.__class__.__name__
  }
  error = json.dumps(err)
...
try:
  rpt = eda_bivariate.plotBivariate()
except Exception as e:
  err = {
...
try:
  rpt = eda_bivariate.plotBivariateCorrelations()
except Exception as e:
  err = {
    "sourceName": "Data Profiling - DataPrep: DataPrep Profiling",
    "errorCode": "600",
