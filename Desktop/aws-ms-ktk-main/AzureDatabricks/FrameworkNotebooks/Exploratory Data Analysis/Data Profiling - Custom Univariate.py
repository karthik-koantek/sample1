...
# MAGIC %md # Data Profiling Custom Univariate
...
widgets = ["stepLogGuid","stepKey","tableName","deltaHistoryMinutes","samplePercent","columnToAnalyze"]
secrets = []
...
# MAGIC %md
# MAGIC #### Univariate Object

# COMMAND ----------

try:
  eda_univariate = ktk.Univariate(dfList[-1], snb.tableName, snb.columnToAnalyze)
except Exception as e:
  err = {
    "sourceName": "Data Profiling - Custom: Univariate Object",
    "errorCode": "400",
    "errorDescription": e.__class__.__name__
  }
  error = json.dumps(err)
...
# MAGIC %md
# MAGIC #### Display Univariate

# COMMAND ----------

try:
  eda_univariate.displayUnivariate()
except Exception as e:
  err = {
    "sourceName": "Data Profiling - Custom: Display Univariate",
    "errorCode": "700",
    "errorDescription": e.__class__.__name__
  }
  error = json.dumps(err)
