...
# MAGIC %md # Data Profiling - DataPrep Univariate
...
try:
  ...
  err = {
    "sourceName": "Data Profiling - DataPrep: Univariate Object",
    "errorCode": "400",
    "errorDescription": e.__class__.__name__
  }
  error = json.dumps(err)
...
try:
  rpt = eda_univariate.plotUnivariate()
except Exception as e:
  err = {
...
try:
  rpt = eda_univariate.plotUnivariateCorrelations()
except Exception as e:
  err = {
    "sourceName": "Data Profiling - DataPrep: DataPrep Profiling",
    "errorCode": "600",
