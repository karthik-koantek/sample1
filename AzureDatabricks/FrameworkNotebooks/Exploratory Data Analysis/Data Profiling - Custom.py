...
# MAGIC %md # Data Profiling - Custom
...
if refreshed == False:
  err = {
    "sourceName": "Data Profiling - Custom: Refresh Table",
    "errorCode": "100",
...
if int(snb.deltaHistoryMinutes) != -1:
  try:
    ...
    err = {
      "sourceName" : "Data Profiling - Custom: Obtain Change Delta",
      "errorCode" : "200",
...
try:
  ...
  err = {
    "sourceName": "Data Profiling - Custom: EDA Object",
    "errorCode": "400",
    "errorDescription": e.__class__.__name__
  }
  error = json.dumps(err)
...
# MAGIC %md
# MAGIC ##### Display General Info

# COMMAND ----------

try:
  eda_general_info.displayGeneralInfo()
except Exception as e:
  err = {
    "sourceName": "Data Profiling - Custom: Display General Info",
    "errorCode": "500",
    "errorDescription": e.__class__.__name__
  }
  error = json.dumps(err)
...
# MAGIC %md
# MAGIC ##### Tabular General Info

# COMMAND ----------

try:
  eda_general_info.setSummaryInfo()
  display(eda_general_info.summary)
except Exception as e:
  err = {
    "sourceName": "Data Profiling - Custom: Tabular General Info",
    "errorCode": "600",
    "errorDescription": e.__class__.__name__
  }
  error = json.dumps(err)
...
eda_general_info.plotContinuousColumns(removeOutliers)
...
eda_general_info.plotCategoricalColumns()
...
pdCorr = eda_general_info.getCorrelations()
pdCorr

# COMMAND ----------

fig = eda_general_info.plotCorrelations()
display(fig.figure)
