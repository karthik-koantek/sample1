...
e = ktk.RandomForestRegressorExperiment(snb, snb.experimentName)
e.displayAttributes()
...
if snb.tableName == "":
  ...
  err = {
    "sourceName": "Random Forest Regression: Validation",
    "errorCode": "100",
...
try:
  ...
  err = {
    "sourceName": "Train Random Forest Regression: Train",
    "errorCode": "200",
