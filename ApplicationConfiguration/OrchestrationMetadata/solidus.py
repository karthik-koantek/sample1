...
def hydrate(project_name):
  ...
  #hydrate batch sql (empty)
    ...
    onb.hydrate_batch_snowflake(
	 Query= compose_client_id_detection_query(solidus_client= 'DATABRICKS_PILOT', exec_time_millis = 1649073849000, days_back = 3, database_name = 'SOLIDUS_PERFORM'),
  sfSchema="",
  sfTable="",  
  ...
  "solidus_client": "DATABRICKS_PILOT",
  "env": "perform",
  "tableName": tableName,
