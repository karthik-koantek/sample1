...
[string]$ExternalSQLServerName = "dbvdc.database.windows.net"
[string]$ExternalDatabaseName = "dbvdc"
[string]$ExternalDatabaseLogin = "dbvdc"
[string]$ExternalDatabasePwd = "@armdep10yment@dmin"
