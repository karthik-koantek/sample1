...
Write-Host "$(Get-Date -Format G) : Running UAT_GoldZone Job"
$JobRun = Invoke-DatabricksJob -BaseURI $URIBase -Token $Token -JobName "UAT_GoldZone"
Do {
    Start-Sleep 60
...
Describe 'UAT_GoldZone Testing' {
    Context 'UAT_GoldZone' {
        It 'Should Succeed' {
